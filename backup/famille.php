...
<title>myretooch.com::<?php echo strtolower(_FAMILLE); ?></title>
<!-- Favicon -->
...
<div id="mnu_famille1" class="actif"><table height="44px" width="156px" border="0"><tr valign="middle" align="center"><td><blink><?php echo _FAMILLE; ?></blink></td></tr></table></div>
</div>
<div id="fond_service">
			...
			while ($Fichier = readdir($dossier)) {
			  if ($Fichier != "." && $Fichier != "..") {
				...
				if (substr($nomFichier,strlen($nomFichier)-2,2)!='db') {
					//echo $nomFichier.'<br />';
					$apres[$i]=$nomFichier;
					$avant[$i]='photos/famille/avant/'.$Fichier;
					$i++;
				}
			  }
			}
