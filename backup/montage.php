...
<title>myretooch.com::<?php echo strtolower(_MONTAGE); ?></title>
<!-- Favicon -->
...
<div id="mnu_montage1" class="actif"><table height="44px" width="249px" border="0"><tr valign="middle" align="center"><td><blink><?php echo _MONTAGE; ?></blink></td></tr></table></div>
...
<div id="fond_service">
			...
			while ($Fichier = readdir($dossier)) {
			  if ($Fichier != "." && $Fichier != "..") {
				...
				if (substr($nomFichier,strlen($nomFichier)-2,2)!='db') {
					//echo $nomFichier.'<br />';
					$apres[$i]=$nomFichier;
					$avant[$i]='photos/montage/avant/'.$Fichier;
					$i++;
				}
			  }
			}
  ...
  ?>
  <!--<div class="panel" align="center">
	 <a href="javascript:;" onmouseout="MM_swapImgRestore(); document.getElementById('avant_apres1').innerHTML='<?php //echo _APRES; ?>'" onmouseover="MM_swapImage('Image17','','photos/montage/avant/Photo_01.jpg',0); document.getElementById('avant_apres1').innerHTML='<?php //echo _AVANT; ?>'"><img src="photos/montage/apres/Photo_02.jpg" name="Image17" id="Image17" height="490px" style="border:2px solid #E938AF" /></a>
 ...
 <div class="panel" align="center">
 	<a href="javascript:;" onmouseout="MM_swapImgRestore(); document.getElementById('avant_apres2').innerHTML='<?php //echo _APRES; ?>'" onmouseover="MM_swapImage('Image18','','photos/montage/avant/Photo_A.jpg',0); document.getElementById('avant_apres2').innerHTML='<?php //echo _AVANT; ?>'"><img src="photos/montage/apres/Photo_C.jpg" name="Image18" id="Image18" height="490px" style="border:2px solid #E938AF" /></a>
 ...
 <div class="panel" align="center">
 	<a href="javascript:;" onmouseout="MM_swapImgRestore(); document.getElementById('avant_apres3').innerHTML='<?php //echo _APRES; ?>'" onmouseover="MM_swapImage('Image19','','photos/montage/avant/Photo_B.jpg',0); document.getElementById('avant_apres3').innerHTML='<?php //echo _AVANT; ?>'"><img src="photos/montage/apres/Photo_C.jpg" name="Image19" id="Image19" height="490px" style="border:2px solid #E938AF" /></a>
 ...
 <div class="panel" align="center">
 	<a href="javascript:;" onmouseout="MM_swapImgRestore(); document.getElementById('avant_apres4').innerHTML='<?php //echo _APRES; ?>'" onmouseover="MM_swapImage('Image20','','photos/montage/avant/Relooking_01.jpg',0); document.getElementById('avant_apres4').innerHTML='<?php //echo _AVANT; ?>'"><img src="photos/montage/apres/Relooking_02.jpg" name="Image20" id="Image20" height="490px" style="border:2px solid #E938AF" /></a>
   ...
   <ul class="filmstrip" style="display:none">
	...
	?>
    <!--<li><img src="photos/montage/apres/Photo_02.jpg" height="100px" width="67px" /></li>
    <li><img src="photos/montage/apres/Photo_C.jpg" height="100px" width="67px" /></li>
    <li><img src="photos/montage/apres/Photo_C.jpg" height="100px" width="67px" /></li>
    <li><img src="photos/montage/apres/Relooking_02.jpg" height="100px" width="67px" /></li>-->
  </ul>
</div>
