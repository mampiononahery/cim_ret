...
<title>myretooch.com::<?php echo strtolower(_MARIAGE); ?></title>
<!-- Favicon -->
...
<div id="mnu_mariage1" class="actif"><table height="44px" width="102px" border="0"><tr valign="middle" align="center"><td><blink><?php echo _MARIAGE; ?></blink></td></tr></table></div>
			...
			while ($Fichier = readdir($dossier)) {
			  if ($Fichier != "." && $Fichier != "..") {
				...
				if (substr($nomFichier,strlen($nomFichier)-2,2)!='db') {
					//echo $nomFichier.'<br />';
					$apres[$i]=$nomFichier;
					$avant[$i]='photos/mariage/avant/'.$Fichier;
					$i++;
				}
			  }
			}
