...
<body onselectstart="return false" oncontextmenu="return false" ondragstart="return false" onMouseOver="window.status=''; return true;">
  ...
  <form name="ftp_local" action="cod_download.php" enctype="multipart/form-data" method="post">
    ...
    <?php
		...
		ftp_login($Connexion, FTP_LOGIN, FTP_PASSWORD);
    ...
    <tr <?php if ($i%2==0) echo 'bgcolor="#B0DBFD"'; else echo 'bgcolor="#D8EDFE"';?> class="table_contenu"> 
      ...
      <td width="15%"><a href="livraison.php?dossier=<?php echo $dossier.substr($Fichier, $Position+1).'/'; ?>"><?php echo utf8_decode(substr($Fichier, $Position+1)); ?></a></td>
    ...
    <tr <?php if ($i%2==0) echo 'bgcolor="#B0DBFD"'; else echo 'bgcolor="#D8EDFE"';?> class="table_contenu"> 
     ...
     <!--                 ito miala  <td width="15%"><a href="http://www.myretooch.com/<?php echo substr($dossier,1,strlen($dossier)); ?><?php echo substr($Fichier, $Position+1); ?>"><?php echo substr($Fichier, $Position+1); ?></a></td>!-->
      ...
      <td align="center"><img class="thumbnail" src="http://www.myretooch.com/<?php echo substr($dossier,1,strlen($dossier)); ?><?php echo substr($Fichier, $Position+1); ?>" height="56"></td>
    </tr>
    <?php
			}
		}
