	...
	<script language="JavaScript" type="text/javascript">
		function supprimer(i,j) {
			if (confirm('Etes-vous sûr de vouloir supprimer '+j+' ?')) {
				document.location.href='cod_tirage.php?id='+i+'&opt=suppr';
			}
		}
	</script>
	<!--nyroModal-->
...
<table width="991px" border="0" align="center" cellpadding="2" cellspacing="1">
  ...
  <tr bgcolor="#000000" class="table_entete"> 
    ...
    <td><div align="center"><a href="edit_tirage.php?opt=new" title="Nouveau tirage" class="nyroModal"><img src="images/edit_add-32.png" width="16" height="16"></a></div></td>
  </tr>
  <?php
  	$lignes=20;
  ...
  <tr <?php if ($i%2==0) echo 'bgcolor="#B0DBFD"'; else echo 'bgcolor="#D8EDFE"';?> class="table_contenu"> 
    ...
    <td><div align="center"> 
		...
		?>
        <a href="javascript:;" onClick="supprimer('<?php echo $id_tirage; ?>','<?php echo $lib_tirage; ?>');" title="supprimer <?php echo $lib_tirage; ?>"><img src="images/ImgDelete.gif" width="16" height="16"></a> 
        <?php
		//}
		?>
      </div></td>
    <td><a href="edit_tirage.php?opt=maj&id=<?php echo $id_tirage; ?>" class="nyroModal" title="<?php echo $lib_tirage; ?>"><?php echo $lib_tirage; ?></a></td>
    <td colspan="2" align="center">&euro;<?php echo number_format($tarif_tirage,2,'.',' '); ?></td>
  </tr>
  <?php
  	$i++;
  	}
