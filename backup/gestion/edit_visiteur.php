...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#AFA99B">
  <tr> 
    <td width="20%" class="table_entete" align="center">#</td>
    <td width="40%" class="table_entete" align="center">Heures</td>
  </tr>
<?php
	$i=1;
	$sql="SELECT * FROM visiteurs WHERE flags='$flags' AND datevisite='$datevisite' ORDER BY heurevisite DESC";
...
?>
  <tr>
    ...
    <td align="center"><?php echo $heurevisite; ?></td>
  </tr>
<?php
	$i++;
	}
