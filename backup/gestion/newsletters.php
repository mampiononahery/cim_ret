...
<script language="JavaScript" type="text/javascript">
	function supprimer(i) {
		if (confirm('Etes-vous sûr de vouloir supprimer '+i+' ?')) {
			document.location.href='cod_newsletter.php?id='+i;
		}
	}
</script>
<!--nyroModal-->
...
<body onselectstart="return false" oncontextmenu="return false" ondragstart="return false" onMouseOver="window.status=''; return true;">
  ...
  ?>
    <tr <?php if ($i%2==0) echo 'bgcolor="#B0DBFD"'; else echo 'bgcolor="#D8EDFE"';?> class="table_contenu"> 
      ...
      <td><div align="center"><a href="javascript:;" onClick="supprimer('<?php echo $email; ?>');" title="supprimer <?php echo $email; ?>"><img src="images/ImgDelete.gif" width="16" height="16"></a></div></td>
      <td align="center"><?php if (@mysql_result(mysql_query("SELECT id_client FROM clients WHERE email_client='$email'"),0)) {?><img src="images/publish_g.png" width="12" height="12" title="OUI" /><?php } else { ?><img src="images/publish_x.png" width="12" height="12" title="NON" />        <?php } ?></td>
