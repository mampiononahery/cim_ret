...
<title>myretooch.com::<?php echo strtolower(_TARIFS); ?></title>
<!-- Favicon -->
...
?>
<div id="mnu_tarif" class="actif_autres"><span class="txt_mnu"><?php echo _TARIFS; ?></span></div>
...
<div id="fond_tarif">
    ...
    <div id="cadre_prix">
        <table width="90%" cellspacing="0" cellpadding="2" align="center" style="margin-top:10px;border:1px solid #FFF">
          <tr bgcolor="#FFF" style="color:#f8bb49; font-size:20px"> 
            <td align="left">&nbsp;&nbsp;<?php echo _SERVICE; ?></td>
            <td align="right">&nbsp;&nbsp;</td>
          </tr>
          <?php
		$requete="SELECT * FROM formules ORDER BY remise ASC";
	...
	?>
          <tr style="color:#FFF; font-family:Tahoma, Geneva, sans-serif; font-size:14px">
            <td align="left">&nbsp;&nbsp;<b>&bull;</b> <?php /*echo traduire($lib_formule); */ echo $lib_formule; ?></td>
            <td align="right"><b><?php echo number_format($remise,2,'.',' '); ?> &euro;&nbsp;&nbsp;</b></td>
          </tr>
          <?php
		}
		?>
        </table>
        <!--<table width="90%" border="0" cellspacing="0" cellpadding="2" align="center" style="margin-top:10px;border:1px solid #FFF">
          <tr bgcolor="#FFF" style="color:#f8bb49; font-size:20px"> 
            <td align="left">&nbsp;&nbsp;<?php //echo _ABN; ?></td>
	...
	?>
          <tr style="color:#FFF; font-family:Tahoma, Geneva, sans-serif; font-size:14px">
            <td align="left">&nbsp;&nbsp;<b>&bull;</b> <?php //echo traduire_abonner($lib_formule); ?></td>
            <td align="center">&nbsp;&nbsp;<?php //echo $nb_photos; ?></td>
            <td align="right"><b style="font-size:12px; color:#F00; text-decoration:line-through"><?php //echo number_format($tarif_service*$nb_photos,2,'.',' '); ?> &euro;</b> <b><?php //echo number_format(($tarif_service-($tarif_service*$remise))*$nb_photos,2,'.',' '); ?> &euro;&nbsp;&nbsp;</b></td>
          </tr>-->
          <?php
		//}
		?>
        ...
        <tr style="font-family:Tahoma, Geneva, sans-serif" >
        	<td colspan="3"><font style="font-size:12px"><?php echo _DEVIS; ?></font> <a href="contact.php?lang=<?php echo $lang; ?>" style="font-size:14px; font-weight:bold"><?php echo _CONTACTER; ?></a>.</td>
