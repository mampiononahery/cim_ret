...
//$notify_email =  "andry.ratobison@gmail.com";
//email address to which debug emails are sent to
$DB_Server = "localhost"; //your MySQL Server
$DB_Username = "u24myretooch"; //your MySQL User Name
$DB_Password = "XRI0g05rfPVYO"; //your MySQL Password
$DB_DBName = "db24Myretooch"; //your MySQL Database Name
...
$sihay = mysql_query($checkquery) or die("La requete de duplication txn id a echoue:<br>" . mysql_error() . "<br>" . mysql_errno());
...
//execute query
    ...
    $strQuery = "insert into paypal_payment_info(paymentstatus,buyer_email,firstname,lastname,street,city,state,zipcode,country,mc_gross,mc_fee,memo,paymenttype,paymentdate,txnid,pendingreason,reasoncode,tax,datecreation) values ('".$payment_status."','".$payer_email."','".$first_name."','".$last_name."','".$address_street."','".$address_city."','".$address_state."','".$address_zip."','".$address_country."','".$mc_gross."','".$mc_fee."','".$memo."','".$payment_type."','".$payment_date."','".$txn_id."','".$pending_reason."','".$reason_code."','".$tax."','".$fecha."')";
     ...
     $result = mysql_query($strQuery) or die("Panier - paypal_payment_info, requete echouee:<br>" . mysql_error() . "<br>" . mysql_errno());
     for ($i = 1; $i <= $num_cart_items; $i++) {
         ...
         $result = mysql_query($struery) or die("Panier - paypal_cart_info, requete echouee:<br>" . mysql_error() . "<br>" . mysql_errno());
     ...
     $result = mysql_query("insert into paypal_payment_info(paymentstatus,buyer_email,firstname,lastname,street,city,state,zipcode,country,mc_gross,mc_fee,itemnumber,itemname,os0,on0,os1,on1,quantity,memo,paymenttype,paymentdate,txnid,pendingreason,reasoncode,tax,datecreation) values ('".$payment_status."','".$payer_email."','".$first_name."','".$last_name."','".$address_street."','".$address_city."','".$address_state."','".$address_zip."','".$address_country."','".$mc_gross."','".$mc_fee."','".$item_number."','".$item_name."','".$option_name1."','".$option_selection1."','".$option_name2."','".$option_selection2."','".$quantity."','".$memo."','".$payment_type."','".$payment_date."','".$txn_id."','".$pending_reason."','".$reason_code."','".$tax."','".$fecha."')") or die("Defaut - paypal_payment_info, requete echouee:<br>" . mysql_error() . "<br>" . mysql_errno());
    }
 ...
 echo "VERIFIE";
	...
	//$mail->AddCC('j.iboura@live.fr', 'James IBOURA');
	$mail->AddBCC('andry.ratobison@gmail.com', 'Andrianandraina RATOBISON');

	//subject
	$mail->Subject='IPN VERIFIE';
	$mail->Body=$res.'<br>'.$req.'<br>'.$strQuery.'<br>'.$struery.'<br>'.$strQuery2;
	$mail->Send();
	$mail->SmtpClose();
	unset($mail);
...
// send an email
	...
	//subject
	$mail->Subject='TRANSACTION DUPLIQUEE VERIFIEE';
	$mail->Body=$res.'<br>'.$req.'<br>'.$strQuery.'<br>'.$struery.'<br>'.$strQuery2;
	$mail->Send();
	$mail->SmtpClose();
	unset($mail);
...
//mail($notify_email, "VERIFIED DUPLICATED TRANSACTION", "$res\n $req \n $strQuery\n $struery\n  $strQuery2");
    ...
    if ( $txn_type == "subscr_signup"  ||  $txn_type == "subscr_payment"  ) {
      ...
      $strQuery = "insert into paypal_payment_info(paymentstatus,buyer_email,firstname,lastname,street,city,state,zipcode,country,mc_gross,mc_fee,memo,paymenttype,paymentdate,txnid,pendingreason,reasoncode,tax,datecreation) values ('".$payment_status."','".$payer_email."','".$first_name."','".$last_name."','".$address_street."','".$address_city."','".$address_state."','".$address_zip."','".$address_country."','".$mc_gross."','".$mc_fee."','".$memo."','".$payment_type."','".$payment_date."','".$txn_id."','".$pending_reason."','".$reason_code."','".$tax."','".$fecha."')";
      $result = mysql_query($strQuery) or die("Inscription - paypal_payment_info, requete echouee:<br>" . mysql_error() . "<br>" . mysql_errno());
        ...
        $result = mysql_query($strQuery2) or die("Inscription - paypal_subscription_info, requete echouee:<br>" . mysql_error() . "<br>" . mysql_errno());
...
// log for manual investigation
	...
	//subject
	$mail->Subject='IPN INVALIDE';
	$mail->Body=$res.'<br>'.$req;
	$mail->Send();
	$mail->SmtpClose();
	unset($mail);
