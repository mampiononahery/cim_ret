...
<title>myretooch.com::<?php echo strtolower(_PRESSE_MAGAZINE); ?></title>
<!-- Favicon -->
...
<div id="mnu_presse1" class="actif"><table height="44px" width="154px" border="0"><tr valign="middle" align="center"><td><blink><?php echo _PRESSE_MAGAZINE; ?></blink></td></tr></table></div>
...
<div id="fond_service">
    ...
    ?>
    <?php
  	for ($i=0;$i<=sizeof($magazine)-1;$i++) {
  ?>
  		<div class="panel" align="center">
	 <a href="javascript:;"><img src="<?php echo $magazine[$i]; ?>" name="Image<?php echo $i+170; ?>" id="Image<?php echo $i+170; ?>"  height="500px" style="border:2px solid #E938AF" /></a>
  </div>
  <?php
	}
  ?>
  <!--<div class="panel" align="center">
	 <a href="javascript:;"><img src="photos/presse-magazine/1newface.jpg" name="Image17" id="Image17" height="500px" style="border:2px solid #E938AF" /></a>
  </div>
 <div class="panel" align="center">
 	<a href="javascript:;"><img src="photos/presse-magazine/2beauteblack.jpg" name="Image18" id="Image18" height="500px" style="border:2px solid #E938AF" /></a>
  </div>
 <div class="panel" align="center">
 	<a href="javascript:;"><img src="photos/presse-magazine/3booker.jpg" name="Image19" id="Image19" height="500px" style="border:2px solid #E938AF" /></a>
  </div>
  <div class="panel" align="center">
 	<a href="javascript:;"><img src="photos/presse-magazine/4ines.jpg" name="Image20" id="Image20" height="500px" style="border:2px solid #E938AF" /></a>
  </div>-->
 <ul class="filmstrip" style="display:none">
 	<?php
  		for ($i=0;$i<=sizeof($magazine)-1;$i++) {
  	?>
    		<li><img src="<?php echo $magazine[$i]; ?>" height="100px" width="67px" /></li>
    <?php
		}
	?>
    <!--<li><img src="photos/presse-magazine/1newface.jpg" height="100px" width="67px" /></li>
    <li><img src="photos/presse-magazine/2beauteblack.jpg" height="100px" width="67px" /></li>
    <li><img src="photos/presse-magazine/3booker.jpg" height="100px" width="67px" /></li>
    <li><img src="photos/presse-magazine/4ines.jpg" height="100px" width="67px" /></li>-->
  </ul>
</div>
