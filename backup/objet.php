...
<title>myretooch.com::<?php echo strtolower(_OBJET); ?></title>
<!-- Favicon -->
...
<div id="mnu_objet1" class="actif"><table height="44px" width="85px" border="0"><tr valign="middle" align="center"><td><blink><?php echo _OBJET; ?></blink></td></tr></table></div>
			...
			while ($Fichier = readdir($dossier)) {
			  if ($Fichier != "." && $Fichier != "..") {
				...
				if (substr($nomFichier,strlen($nomFichier)-2,2)!='db') {
					//echo $nomFichier.'<br />';
					$apres[$i]=$nomFichier;
					$avant[$i]='photos/objet/avant/'.$Fichier;
					$i++;
				}
			  }
			}
