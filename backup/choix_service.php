<?php
	...
	$sql="SELECT id_client FROM clients WHERE id_client='$id_client'";
	if (mysql_num_rows(mysql_query($sql))==0)
		mysql_query("DELETE FROM abonnements WHERE id_client='$id_client'");
...
<title>myretooch.com::<?php echo strtolower(_FORMULE); ?></title>
<!-- Favicon -->
...
<div id="mnu_montage1"><table height="44px" width="249px" border="0"><tr valign="middle" align="center"><td><blink><?php echo _FORMULE; ?></blink></td></tr></table></div>
...
<div id="mnu_presse1"><table height="44px" width="154px" border="0"><tr valign="middle" align="center"><td><?php
				if (!empty($id_client) && mysql_result(mysql_query("SELECT COUNT(id_client) FROM clients WHERE id_client='$id_client'"),0)!=0) {
			?><a href="abonnements.php?lang=<?php echo $lang; ?>">Mes abonnements</a>
            <?php
				}
            ?></td></tr></table></div>
...
<div id="fond_connexion">
	<div id="info_contact">
    	<div id="titre_contact"><?php echo ucfirst(strtolower(_CONTACT)); ?></div><div id="contenu_contact">BUREAU DE LIAISON<br />
    	  <span class="adr">14 Avenue de l'Opéra<br />75002 Paris (France)</span></div>
    ...
    <div id="form_contact">
    	<div id="cadre_ncli" align="center">
   			<input type="submit" name="Submit" value="<?php echo strtoupper(_SERVICE); ?>" id="Submit" style="width:250px; height:250px; font-size:25px; font-weight:bold; cursor:pointer;" onclick="location.href='monpanier.php?lang=<?php echo $lang; ?>'" <?php if ($ok==1) echo 'disabled'; ?> />
        </div>
    	<div id="cadre_connexion" align="center">
	        <input type="submit" name="Submit" value="<?php echo strtoupper(_ABN); ?>" id="Submit" style="width:250px; height:250px; font-size:25px; font-weight:bold; cursor:pointer;" onclick="location.href='monabonnement.php?lang=<?php echo $lang; ?>'" <?php if ($ok==1) echo 'disabled'; ?> />
    	</div>
    </div>
</div>
<?php
