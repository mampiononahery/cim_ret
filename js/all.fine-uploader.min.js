...
!function () {
    ...
    var b, c, d, e, f, g, h, i, j = "qq-file-id", k = "qq-file-id-", l = "qq-max-size", m = "qq-server-scale", n = "qq-hide-dropzone", o = "qq-drop-area-text", p = "qq-in-progress", q = "qq-hidden-forever", r = {content: document.createDocumentFragment(), map: {}}, s = !1, t = 0, u = !1, v = [], w = -1, x = {log: null, limits: {maxThumbs: 0, timeBetweenThumbs: 750}, templateIdOrEl: "qq-template", containerEl: null, fileContainerEl: null, button: null, imageGenerator: null, classes: {hide: "qq-hide", editable: "qq-editable"}, placeholders: {waitUntilUpdate: !1, thumbnailNotAvailable: null, waitingForThumbnail: null}, text: {paused: "Paused"}}, y = {button: "qq-upload-button-selector", alertDialog: "qq-alert-dialog-selector", dialogCancelButton: "qq-cancel-button-selector", confirmDialog: "qq-confirm-dialog-selector", dialogMessage: "qq-dialog-message-selector", dialogOkButton: "qq-ok-button-selector", promptDialog: "qq-prompt-dialog-selector", uploader: "qq-uploader-selector", drop: "qq-upload-drop-area-selector", list: "qq-upload-list-selector", progressBarContainer: "qq-progress-bar-container-selector", progressBar: "qq-progress-bar-selector", totalProgressBarContainer: "qq-total-progress-bar-container-selector", totalProgressBar: "qq-total-progress-bar-selector", file: "qq-upload-file-selector", spinner: "qq-upload-spinner-selector", size: "qq-upload-size-selector", cancel: "qq-upload-cancel-selector", pause: "qq-upload-pause-selector", continueButton: "qq-upload-continue-selector", deleteButton: "qq-upload-delete-selector", retry: "qq-upload-retry-selector", statusText: "qq-upload-status-text-selector", editFilenameInput: "qq-edit-filename-selector", editNameIcon: "qq-edit-filename-icon-selector", dropText: "qq-upload-drop-area-text-selector", dropProcessing: "qq-drop-processing-selector", dropProcessingSpinner: "qq-drop-processing-spinner-selector", thumbnail: "qq-thumbnail-selector"}, z = {}, A = new qq.Promise, B = new qq.Promise, C = function () {
        ...
        var b = a.id, c = a.optFileOrBlob, d = c && c.qqThumbnailId, e = U(b), f = {maxSize: w, scale: !0, orient: !0};
        ...
        var b = a.id, c = a.thumbnailUrl, d = a.showWaitingImg, e = U(b), f = {maxSize: w, scale: i};
        if (e)if (c) {
    ...
    qq.extend(x, a), b = x.log, qq.supportedFeatures.imagePreviews || (x.limits.timeBetweenThumbs = 0, x.limits.maxThumbs = 0), f = x.containerEl, h = void 0 !== x.imageGenerator, e = Y(), C(), qq.extend(this, {render: function () {
        ...
        h && (r.map[a] = l), qq(l).addClass(k + a), n.removeAttribute(o), m && (qq(m).setText(b), m.setAttribute("title", b)), l.setAttribute(j, a), c ? Z(l, c.index, p) : p.appendChild(l), d ? (l.style.display = "none", qq(l).addClass(q)) : (V(P(a)), V(R(a)), V(J(a)), V(Q(a)), V(O(a)), V(H(a)), s && this.hideCancel(a), i = U(a), i && !i.src && B.then(function (a) {
            i.src = a.src, a.style.maxHeight && a.style.maxWidth && qq(i).css({maxHeight: a.style.maxHeight, maxWidth: a.style.maxWidth}), bb(i)
        }))
        ...
        this.isHiddenForever(a) || (v.push({id: a, optFileOrBlob: b}), !u && F())
    }, updateThumbnail: function (a, b, c) {
        this.isHiddenForever(a) || (v.push({update: !0, id: a, thumbnailUrl: b, showWaitingImg: c}), !u && F())
    }, hasDialog: function (a) {
        return qq.supportedFeatures.dialogElement && !!I(a)
    }, showDialog: function (a, b, c) {
        var d = I(a), e = T(d, y.dialogMessage), f = d.getElementsByTagName("INPUT")[0], g = T(d, y.dialogCancelButton), h = T(d, y.dialogOkButton), i = new qq.Promise, j = function () {
    ...
    qq.extend(this, {enabled: qq.supportedFeatures.scaling && i.length > 0, getFileRecords: function (a, j, k) {
        ...
        }), m.push({uuid: a, name: j, size: n.size, blob: c ? n : null})) : m.push({uuid: a, name: j, size: n.size, blob: n}), m
        ...
        qq.each(i.getFileRecords(c, b, a), function (a, b) {
            var c, d = b.size;
            b.blob instanceof qq.BlobProxy && (d = -1), c = m.addFile({uuid: b.uuid, name: b.name, size: d, batchId: f, proxyGroupId: o}), b.blob instanceof qq.BlobProxy ? j.push(c) : k = c, b.blob ? (l(c, b.blob), e.push({id: c, file: b.blob})) : m.setStatus(c, qq.status.REJECTED)
...
qq.TotalProgress = function (a, b) {
    ...
    return{ALGORITHM_PARAM_NAME: "x-amz-algorithm", AWS_PARAM_PREFIX: "x-amz-meta-", CREDENTIAL_PARAM_NAME: "x-amz-credential", DATE_PARAM_NAME: "x-amz-date", REDUCED_REDUNDANCY_PARAM_NAME: "x-amz-storage-class", REDUCED_REDUNDANCY_PARAM_VALUE: "REDUCED_REDUNDANCY", SERVER_SIDE_ENCRYPTION_PARAM_NAME: "x-amz-server-side-encryption", SERVER_SIDE_ENCRYPTION_PARAM_VALUE: "AES256", SESSION_TOKEN_PARAM_NAME: "x-amz-security-token", V4_ALGORITHM_PARAM_VALUE: "AWS4-HMAC-SHA256", V4_SIGNATURE_PARAM_NAME: "x-amz-signature", CASE_SENSITIVE_PARAM_NAMES: ["Cache-Control", "Content-Disposition", "Content-Encoding", "Content-MD5"], UNSIGNABLE_REST_HEADER_NAMES: ["Cache-Control", "Content-Disposition", "Content-Encoding", "Content-MD5"], UNPREFIXED_PARAM_NAMES: ["Cache-Control", "Content-Disposition", "Content-Encoding", "Content-MD5", "x-amz-server-side-encryption-customer-algorithm", "x-amz-server-side-encryption-customer-key", "x-amz-server-side-encryption-customer-key-MD5"], getBucket: function (a) {
        ...
        var c, d = {}, e = a.params, f = new qq.Promise, g = a.sessionToken, h = a.clockDrift, i = a.type, j = a.key, k = a.accessKey, l = a.acl, m = a.expectedStatus, n = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl), o = a.reducedRedundancy, p = a.region, q = a.serverSideEncryption, r = a.signatureVersion, s = new Date, t = a.log;
        ...
        }), 2 === r ? d.AWSAccessKeyId = k : 4 === r && (d[qq.s3.util.ALGORITHM_PARAM_NAME] = qq.s3.util.V4_ALGORITHM_PARAM_VALUE, d[qq.s3.util.CREDENTIAL_PARAM_NAME] = qq.s3.util.getV4CredentialsString({date: s, key: k, region: p}), d[qq.s3.util.DATE_PARAM_NAME] = qq.s3.util.getV4PolicyDate(s, h)), b(c).then(function (b, c, e) {
    ...
    qq.s3.FineUploaderBasic = function (a) {
        var b = {request: {accessKey: null, clockDrift: 0}, objectProperties: {acl: "private", bucket: qq.bind(function (a) {
        ...
        var a = this, b = {aclStore: this._aclStore, getBucket: qq.bind(this._determineBucket, this), getHost: qq.bind(this._determineHost, this), getKeyName: qq.bind(this._determineKeyName, this), iframeSupport: this._options.iframeSupport, objectProperties: this._options.objectProperties, signature: this._options.signature, clockDrift: this._options.request.clockDrift, validation: {minSizeLimit: this._options.validation.minSizeLimit, maxSizeLimit: this._options.validation.sizeLimit}};
    ...
    function c(a, b, c) {
        var d, e, f, g = new qq.Promise, h = "POST", j = [], l = "", o = new Date, p = function (a) {
            ...
            return qq.each(a.headers, function (a) {
                ...
                j.splice(b, 1)
            }), e = {bucket: a.bucket, contentMd5: c, contentType: a.contentType, date: o, drift: k.signatureSpec.drift, endOfUrl: d, hashedContent: a.hashedContent, headerNames: j, headersStr: l, method: h}, f = 2 === b ? m.getStringToSign(e) : n.getStringToSign(e), {date: o, endOfUrl: d, signedHeaders: 4 === b ? n.getSignedHeaders(e.headerNames) : null, toSign: 4 === b ? f.hashed : f, toSignRaw: 4 === b ? f.raw : f}
        };
        switch (c.type) {
    ...
    var g, h, i = this, j = {}, k = {expectingPolicy: !1, method: "POST", signatureSpec: {drift: 0, credentialsProvider: {}, endpoint: null, customHeaders: {}, version: 2}, maxConnections: 3, endpointStore: {}, paramsStore: {}, cors: {expected: !1, sendCredentials: !1}, log: function () {
    }}, l = function (a, b, c) {
        var d = a.getHeaders();
    ...
    }, m = {getStringToSign: function (a) {
        return qq.format("{}\n{}\n{}\n\n{}/{}/{}", a.method, a.contentMd5 || "", a.contentType || "", a.headersStr || "\n", a.bucket, a.endOfUrl)
    }, signApiRequest: function (a, b, c) {
        var d = CryptoJS.enc.Utf8.parse(b), e = CryptoJS.HmacSHA1(d, h.get().secretKey), f = CryptoJS.enc.Base64.stringify(e);
        l(a, f, c)
    ...
    }}, n = {getCanonicalQueryString: function (a) {
        ...
        var b = n.getCanonicalRequest(a), c = qq.s3.util.getV4PolicyDate(a.date, a.drift), d = CryptoJS.SHA256(b).toString(), e = n.getScope(a.date, k.signatureSpec.region), f = "AWS4-HMAC-SHA256\n{}\n{}\n{}";
        ...
        var e, f, g, i, j, k = JSON.stringify(a), l = CryptoJS.enc.Utf8.parse(k), m = CryptoJS.enc.Base64.stringify(l), n = h.get().secretKey, o = /.+\/(.+)\/(.+)\/s3\/aws4_request/, p = function () {
            var b = null;
        ...
        e = o.exec(p), f = CryptoJS.HmacSHA256(e[1], "AWS4" + n), g = CryptoJS.HmacSHA256(e[2], f), i = CryptoJS.HmacSHA256("s3", g), j = CryptoJS.HmacSHA256("aws4_request", i), b.success({policy: m, signature: CryptoJS.HmacSHA256(m, j).toString()}, c, d)
    }};
    qq.extend(k, a, !0), h = k.signatureSpec.credentialsProvider, g = qq.extend(this, new qq.AjaxRequester({acceptHeader: "application/json", method: k.method, contentType: "application/json; charset=utf-8", endpointStore: {get: function () {
        ...
        return 4 === k.signatureSpec.version && (c = {v4: !0}), h.get().secretKey && window.CryptoJS ? h.get().expiration.getTime() > Date.now() ? d(a, b, i) : h.onExpired().then(function () {
        ...
        }) : g.initTransport(a).withParams(e).withQueryParams(c).send(), j[a] = {promise: i, signatureConstructor: f}), i
        ...
        return{withHeaders: function (a) {
            ...
            var o = h.get().sessionToken, p = new qq.Promise, q = new Date(Date.now() + k.signatureSpec.drift);
            return m["x-amz-date"] = q.toUTCString(), o && (m[qq.s3.util.SESSION_TOKEN_PARAM_NAME] = o), c(n, k.signatureSpec.version, {bucket: b, content: g, contentType: i, headers: m, host: d, key: e, partNum: j, type: a, uploadId: f}).then(function (a) {
                l = a, p.success({headers: function () {
                    return i && (m["Content-Type"] = i), delete m.Host, m
                }(), date: l.date, endOfUrl: l.endOfUrl, signedHeaders: l.signedHeaders, stringToSign: l.toSign, stringToSignRaw: l.toSignRaw})
            }), p
        }, getHeaders: function () {
            return qq.extend({}, m)
    ...
    "use strict";
    function b(a, b, c) {
        var d = new qq.Promise, e = h.getBucket(a), g = h.getHost(a), i = f.constructStringToSign(f.REQUEST_TYPE.MULTIPART_COMPLETE, e, g, h.getKey(a)).withUploadId(b).withContent(c).withContentType("application/xml; charset=UTF-8");
    ...
    "use strict";
    function b(a, b) {
        var c = new qq.Promise, d = f.getBucket(a), g = f.getHost(a), h = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_ABORT, d, g, f.getKey(a)).withUploadId(b);
    ...
    var c = b.getName, d = b.log, e = a.clockDrift, f = 200, g = a.getBucket, h = a.getHost, i = a.getKeyName, j = a.filenameParam, k = a.paramsStore, l = a.endpointStore, m = a.aclStore, n = a.objectProperties.reducedRedundancy, o = a.objectProperties.region, p = a.objectProperties.serverSideEncryption, q = a.validation, r = qq.extend({region: o, drift: e}, a.signature), s = this, t = a.signature.credentialsProvider, u = {combine: function (a) {
        ...
        e.success && (d = b.getResponseHeader("ETag"), s._getPersistableData(a).etags || (s._getPersistableData(a).etags = []), s._getPersistableData(a).etags.push({part: c + 1, etag: d}))
    }, initHeaders: function (a, b, c) {
        var d = x.bucket.getName(a), e = x.host.getName(a), f = x.key.urlSafe(a), g = new qq.Promise, h = v.restSignature.constructStringToSign(v.restSignature.REQUEST_TYPE.MULTIPART_UPLOAD, d, e, f).withPartNum(b + 1).withContent(c).withUploadId(s._getPersistableData(a).uploadId);
        return v.restSignature.getSignature(a + "." + b, {signatureConstructor: h}).then(g.success, g.failure), g
    }, put: function (b, c) {
        var d = s._createXhr(b, c), e = s._getChunkData(b, c), f = a.endpointStore.get(b), g = new qq.Promise;
    ...
    }}, v = {abortMultipart: new qq.s3.AbortMultipartAjaxRequester({endpointStore: l, signatureSpec: r, cors: a.cors, log: d, getBucket: function (a) {
        return x.bucket.getName(a)
    }, getHost: function (a) {
        return x.host.getName(a)
    }, getKey: function (a) {
        return x.key.urlSafe(a)
    }}), completeMultipart: new qq.s3.CompleteMultipartAjaxRequester({endpointStore: l, signatureSpec: r, cors: a.cors, log: d, getBucket: function (a) {
        return x.bucket.getName(a)
    }, getHost: function (a) {
        return x.host.getName(a)
    }, getKey: function (a) {
        return x.key.urlSafe(a)
    }}), initiateMultipart: new qq.s3.InitiateMultipartAjaxRequester({filenameParam: j, endpointStore: l, paramsStore: k, signatureSpec: r, aclStore: m, reducedRedundancy: n, serverSideEncryption: p, cors: a.cors, log: d, getContentType: function (a) {
        ...
        return c(a)
    }}), policySignature: new qq.s3.RequestSigner({expectingPolicy: !0, signatureSpec: r, cors: a.cors, log: d}), restSignature: new qq.s3.RequestSigner({endpointStore: l, signatureSpec: r, cors: a.cors, log: d})}, w = {initParams: function (a) {
        var b = k.get(a);
        return b[j] = c(a), qq.s3.util.generateAwsParams({endpoint: l.get(a), clockDrift: e, params: b, type: s._getMimeType(a), bucket: x.bucket.getName(a), key: s.getThirdPartyFileId(a), accessKey: t.get().accessKey, sessionToken: t.get().sessionToken, acl: m.get(a), expectedStatus: f, minFileSize: q.minSizeLimit, maxFileSize: q.maxSizeLimit, reducedRedundancy: n, region: o, serverSideEncryption: p, signatureVersion: r.version, log: d}, qq.bind(v.policySignature.getSignature, this, a))
    }, send: function (a) {
        ...
        return e && x.response.shouldReset(c.code) && (d("This is an unrecoverable error, we must restart the upload entirely on the next retry attempt.", "error"), c.reset = !0), {success: !e, response: c}
    ...
    qq.extend(this, {uploadChunk: x.start, uploadFile: x.start}), qq.extend(this, new qq.XhrUploadHandler({options: qq.extend({namespace: "s3"}, a), proxy: qq.extend({getEndpoint: a.endpointStore.get}, b)})), qq.override(this, function (a) {
        return{expunge: function (b) {
            var c = s._getPersistableData(b) && s._getPersistableData(b).uploadId, d = s._maybeDeletePersistedChunkData(b);
    ...
    function d(a) {
        var b = q.get(a);
        return b[p] = k(a), qq.s3.util.generateAwsParams({endpoint: r.get(a), clockDrift: i, params: b, bucket: h._getFileState(a).bucket, key: h.getThirdPartyFileId(a), accessKey: z.get().accessKey, sessionToken: z.get().sessionToken, acl: s.get(a), minFileSize: w.minSizeLimit, maxFileSize: w.maxSizeLimit, successRedirectUrl: y, reducedRedundancy: t, region: u, serverSideEncryption: v, signatureVersion: x.version, log: m}, qq.bind(A.getSignature, this, a))
    }
    ...
    qq.extend(this, new qq.FormUploadHandler({options: {isCors: !1, inputName: "file"}, proxy: {onCancel: a.onCancel, onUuidChanged: j, getName: k, getUuid: l, log: m}})), qq.extend(this, {uploadFile: function (a) {
    ...
    "use strict";
    return{AZURE_PARAM_PREFIX: "x-ms-meta-", _paramNameMatchesAzureParameter: function (a) {
        switch (a) {
            case"Cache-Control":
    ...
    qq.azure.FineUploaderBasic = function (a) {
        ...
        var b = this._options.blobProperties.name, c = this.getUuid(a), d = this.getName(a), e = qq.getExtension(d), f = c;
...
!function () {
    ...
    var b = CryptoJS, c = b.lib, d = c.WordArray, e = c.Hasher, f = b.algo, g = [], h = [];
    !function () {
        function b(b) {
    ...
    var i = [], j = f.SHA256 = e.extend({_doReset: function () {
        ...
        for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], g = c[3], j = c[4], k = c[5], l = c[6], m = c[7], n = 0; 64 > n; n++) {
            if (16 > n)i[n] = 0 | a[b + n]; else {
                var o = i[n - 15], p = (o << 25 | o >>> 7) ^ (o << 14 | o >>> 18) ^ o >>> 3, q = i[n - 2], r = (q << 15 | q >>> 17) ^ (q << 13 | q >>> 19) ^ q >>> 10;
                i[n] = p + i[n - 7] + r + i[n - 16]
            }
            var s = j & k ^ ~j & l, t = d & e ^ d & f ^ e & f, u = (d << 30 | d >>> 2) ^ (d << 19 | d >>> 13) ^ (d << 10 | d >>> 22), v = (j << 26 | j >>> 6) ^ (j << 21 | j >>> 11) ^ (j << 7 | j >>> 25), w = m + v + s + h[n] + i[n], x = u + t;
    ...
    if ("function" == typeof ArrayBuffer) {
        var a = CryptoJS, b = a.lib, c = b.WordArray, d = c.init, e = c.init = function (a) {
