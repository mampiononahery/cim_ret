...
*/
	...
	*/ 
	...
	// mampionona//
	$config['database']['user_acc']['columns']['prenom_user']= 'prenom_user';
	...
	$config['database']['user_acc']['custom_columns'] = array('mcrypt_password','uacc_active'
	...
	*/
	...
	$config['security']['validate_login_onload'] = FALSE;// mampionona illimité
	...
	*/
	//$config['security']['login_session_expire'] = 60*48;
	//$config['security']['login_session_expire'] =  0; /*CRA : A changer pour tenir compte sess_expiration*/
	$config['security']['login_session_expire'] =  0; //60*60*24; // mampionona on day
	/**
	...
	*/
	$config['email']['email_template_directory'] = 'auth/email/';
