...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1" id="banniere">


            <img src="<?php echo base_url();?>images/banniere_new.jpg" style="padding-right:0px; width:100%;"  height="150"/>
    ...
    <div class="row">
        <div class="col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1" id="connexion">
            <div class="pull-right" style="margin-right:0px;">
                ...
                <form class="form-inline" action="<?php echo base_url('home/login'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="inputEmail" placeholder="Login">
                ...
                <?php } else { ?>
                    Bonjour <?php echo $this->session->userdata('nom'); ?>, <a href="<?php echo base_url('home/logout'); ?>">Deconnexion</a>
                <?php } ?>
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1" id="barre_menu">
           ...
           <span class="pull-right" id="drapeaux">
           	 <a href="#"><img src="<?php echo base_url();?>images/FR.gif"/></a>
           	 <a href="#"><img src="<?php echo base_url();?>images/GB.gif"/></a>
           	 <a href="#"><img src="<?php echo base_url();?>images/ES.gif"/></a>
        </span>
                </div>
