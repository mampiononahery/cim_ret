...
class Flexi_auth_lite_model extends CI_Model
{
	 ...
	 * @author Rob Hussey
	 */
	public function set_custom_sql_to_db($sql_select = FALSE, $sql_where = FALSE,$id_user_remplacer=0) 
	{
		...
		if($id_user_remplacer>0){
			
			$this->db->or_where(array($this->auth->tbl_col_user_privilege_users['user_id'] => $id_user_remplacer));
		}
